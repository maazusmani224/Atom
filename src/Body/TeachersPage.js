...
export default function TeachersPage(){
    ...
    return (
        ...
        {(classopened?
        <TeacherClassFeeds key={101} loading={loading} setLoading={setLoading} classid={openedclassid} setClassOpened={setClassOpened} setOpenedClassId={setOpenedClassId}/>:
        <TeacherClass key={201} loading={loading} setLoading={setLoading} setClassOpened={setClassOpened} setOpenedClassId={setOpenedClassId}/>)}
        </div>
        )
}