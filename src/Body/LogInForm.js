            ...
            <Dialog open={props.open} onClose={props.Close} aria-labelledby="form-dialog-title">
                ...
                <DialogContent>
                    <div className="login__username">
                       <TextField autoComplete="off" required id="standard-required" label="Email" value={email} onChange={(e)=>{setEmail(e.target.value)}} />
                    </div>
                    ...
                    <div className="login__signup">
                       <FormLabel component="legend">Dont have an account? Sign up Now.</FormLabel>
